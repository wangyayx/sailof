(function () {
    ...
    function i18n(ele, options) {
        ...
        ;var tempLang = null;
        var obj = {'async': true, 'success': _success, 'err': _err, '$ele': options.$ele, 'options': options};
        if (options.get) {
            obj.async = false
        }
        obj.url = options.filePath + options.filePrefix + options.lang + options.fileSuffix + ".json";
        i18nLang = _getJSON(obj);
        if (options.get) {
            obj.async = true
        }
        return window['i18n']
        ...
        $ele.forEach(function ($this) {
            ...
            if ($this.getAttribute("value") != null && $this.getAttribute("value") != "") {
                if (i18nOnly == null || i18nOnly == undefined || i18nOnly == "" || i18nOnly == "value") {
                    $this.setAttribute("value", i18nLang[$this.getAttribute("i18n")])
                }
            }
            ...
            if ($this.getAttribute('placeholder') != null && $this.getAttribute('placeholder') != "") {
                if (i18nOnly == null || i18nOnly == undefined || i18nOnly == "" || i18nOnly == "placeholder") {
                    $this.setAttribute('placeholder', i18nLang[$this.getAttribute("i18n")])
                }
            }
        });
        options.callback();
